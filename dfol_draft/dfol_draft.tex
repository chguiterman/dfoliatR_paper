...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={dfoliatR: An R package for identification and analyses of insect defoliation and growth suppression signals in tree rings},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{\emph{dfoliatR}: An R package for identification and analyses of insect
defoliation and growth suppression signals in tree rings}
    \author[]{}
...
Dirac, P.A., 1953. The lorentz transformation and absolute time. Physica
19, 888--896.
