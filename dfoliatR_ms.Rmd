...
```
> This article is published as: Guiterman, CH, AM Lynch, and JN Axelson (2020) `dfoliatR`: An R package for detection and analysis of insect defoliation signals in tree rings. _Dendrochronologia_. DOI: 10.1016/j.dendro.2020.125750. Available for free [(link)](https://authors.elsevier.com/sd/article/S1125786520300898)
...
```{r echo=TRUE, eval=FALSE}
plot_outbreak(dmj_obr, disp_index = "GSI") # Fig. 2
```
...
```{r echo=TRUE, eval=FALSE}
## calculate mean return interval for outbreak 
## start years
